...
public class CommonControllerAdvice {
	...
	public ErrorsDto handleAlreadyStartedFilmException(AlreadyStartedFilmException exception, Locale locale){
		...
		String errorMessage = messageSource.getMessage(ALREADY_STARTED_FILM_EXCEPTION_CODE,
				new Object[] {exception.getLocalDateTime().toString()}, ALREADY_STARTED_FILM_EXCEPTION_CODE, locale);
